...
def downgrade():
    op.drop_index('ix_strategy_performance_id', table_name='strategy_performance')
    op.drop_index('idx_performance_user_id', table_name='strategy_performance')
    op.drop_index('idx_performance_strategy_id', table_name='strategy_performance')
    op.drop_table('strategy_performance')
    
    op.drop_index('ix_strategy_signals_signal_id', table_name='strategy_signals')
    op.drop_index('idx_signals_generated_at', table_name='strategy_signals')
    op.drop_index('idx_signals_ticker', table_name='strategy_signals')
    op.drop_index('idx_signals_strategy_id', table_name='strategy_signals')
    op.drop_table('strategy_signals')
    
    op.drop_index('ix_strategy_backtests_backtest_id', table_name='strategy_backtests')
    op.drop_index('idx_backtests_strategy_id', table_name='strategy_backtests')
    op.drop_table('strategy_backtests')
    
    op.drop_index('ix_trading_strategies_id', table_name='trading_strategies')
    op.drop_index('idx_strategies_user_id', table_name='trading_strategies')
