...
from routes import chat_router, snaptrade_router, resources_router, chat_files_router, api_keys_router, credits_router, reminders_router, alpaca_router, market_router, alpaca_broker_router, execute_router, watchlist_router, push_router, analysis_router
...
app.add_middleware(
    ...
    allow_headers=["Content-Type", "Authorization", "X-Admin-Secret", "Stripe-Signature"],
)
