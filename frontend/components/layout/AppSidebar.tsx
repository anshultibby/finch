...
const ScreenerIcon = () => (
  <svg className="w-[18px] h-[18px]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.8} d="M3.75 6h16.5M6 12h12M10.5 18h3" />
  </svg>
);
...
const AppSidebar = forwardRef<AppSidebarRef, AppSidebarProps>(({
  ...
  const navItems: NavItem[] = [
    ...
    { id: 'screener', label: 'Screener', view: { type: 'screener' }, icon: <ScreenerIcon /> },
    { id: 'analytics', label: 'Analytics', view: { type: 'analytics' }, icon: <AnalyticsIcon /> },
